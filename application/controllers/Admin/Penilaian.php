...
Class Penilaian extends CI_Controller {
    ...
    function index() {
        $data['nilai'] = $this->db->query("SELECT p.id_nilai,s.alamat,s.nama,p.tanggal,pl.bobot,s.nis,p.keterangan,s.no_hp_ortu,pl.nama as tingkat_kenakalan FROM penilaian as p,siswa as s,pelanggaran as pl WHERE p.id_pelanggaran=pl.id and p.nis=s.nis")->result();
    ...
    function add() {
        if (isset($_POST['submit'])) {
            ...
            echo $this->session->set_flashdata('Berhasil', 'Berhasil Menambahkan....');
    ...
    function Hapus(){
        ...
        echo $this->session->set_flashdata('hapus', 'Berhasil Menghapus....');
        redirect('Admin/Penilaian');
    }
